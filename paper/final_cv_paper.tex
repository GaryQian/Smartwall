...
\begin{center}
	...
	\vspace{0.1cm}
	\small{\textbf{Figure 1: } \textit{Custom Calibration Matrix}}
\end{center}
...
\vspace{0.25cm}
\small{\textbf{Figure 2: } \textit{Custom Training Data}}
\end{center}
...
\begin{center}
	...
	\vspace{0.25cm}
	\small{\textbf{Figure 3: } \textit{Sample Drawing Made with SmartWall}}
\end{center}
