...
We found that for maximum precision, the cursor was always located in the center of the marker during our tests as long as the camera had not moved since calibration. We also found that the system performed best when the hand was flush against the target surface.
