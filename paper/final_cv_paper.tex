...
For successful object detection by the camera, 

\subsection{Training}
Training for subsequent object recognition was performed using the Keras library for Python. Over 4000 images of open and closed hands under varying skin tones and lighting conditions and with differing backgrounds were captured to accumulate a training data set. In captured images, a green square with optimal hue for camera calibration was placed onto the hand; a red dot was then superimposed programmatically onto the hand to allow for different color recognition and color-agnostic training by the neural network. \\ \\
...
The network topology was defined in Keras and the model trained using 100 epochs and a batch size of 32. This training allowed for subsequent object recognition of open and closed hands with over 99\% accuracy under controlled conditions.
